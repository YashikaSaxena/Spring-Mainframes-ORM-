...
<table id="t01" align="center" border="1">
  ...
  <tr>
    ...
    <div>
      <form>
      <button class="ed" formaction="viewExam"  >View <i class="fa fa-eye"></i></button> </form>
	<button  data-inline="true" class="ed"  onclick="deleteRow(this)" >Delete <i class="fa fa-trash"></i></button>  
  ...
  <tr>
   ...
   <button class="ed" formaction="viewExam"  >View <i class="fa fa-eye"></i></button>
